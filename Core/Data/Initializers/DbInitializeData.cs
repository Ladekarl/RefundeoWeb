...
namespace Refundeo.Core.Data.Initializers
{
    ...
    {
        public static readonly List<CityDto> CitiesToCreate = new List<CityDto>
        {
            new CityDto
            {
                Name = "Barcelona",
        ...
        public static readonly List<MerchantRegisterDto> MerchantsToCreate = new List<MerchantRegisterDto>
        {
            new MerchantRegisterDto
            {
                ...
                City = CitiesToCreate.FirstOrDefault(c => c.Name == "Barcelona")
            },
            new MerchantRegisterDto
            {
                Username = "Klarlund",
                ...
                City = CitiesToCreate.FirstOrDefault(c => c.Name == "Paris")
            },
            new MerchantRegisterDto
            {
                Username = "Neye",
                ...
                City = CitiesToCreate.FirstOrDefault(c => c.Name == "Rome")
            },
            new MerchantRegisterDto
            {
                Username = "Magasin",
