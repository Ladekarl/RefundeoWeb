    ...
    public static class DbInitializeData
    {
        ...
        public static readonly List<MerchantRegisterDto> MerchantsToCreate = new List<MerchantRegisterDto>
        {
            new MerchantRegisterDto
            {
                ...
                Banner = "https://refundeodevstorage.blob.core.windows.net/merchantbanners/Louis Vuitton-2-banner",
                Logo = "https://refundeodevstorage.blob.core.windows.net/merchantlogos/Louis Vuitton-2-logo",
                Description =
            ...
            new MerchantRegisterDto
            {
                ...
                Banner = "https://refundeodevstorage.blob.core.windows.net/merchantbanners/Klarlund-3-banner",
                Logo = "https://refundeodevstorage.blob.core.windows.net/merchantlogos/Klarlund-3-logo",
                Description =
            ...
            new MerchantRegisterDto
            {
                ...
                Banner = "https://refundeodevstorage.blob.core.windows.net/merchantbanners/Neye-4-banner",
                Logo = "https://refundeodevstorage.blob.core.windows.net/merchantlogos/Neye-4-logo",
                Description =
            ...
            new MerchantRegisterDto
            {
                ...
                Banner = "https://refundeodevstorage.blob.core.windows.net/merchantbanners/Magasin-5-banner",
                Logo = "https://refundeodevstorage.blob.core.windows.net/merchantlogos/Magasin-5-logo",
                Description =
            ...
            new MerchantRegisterDto
            {
                ...
                Banner = "https://refundeodevstorage.blob.core.windows.net/merchantbanners/Storm-6-banner",
                Logo = "https://refundeodevstorage.blob.core.windows.net/merchantlogos/Storm-6-logo",
                Description =
            ...
            new MerchantRegisterDto
            {
                ...
                Banner = "https://refundeodevstorage.blob.core.windows.net/merchantbanners/Ganni-7-banner",
                Logo = "https://refundeodevstorage.blob.core.windows.net/merchantlogos/Ganni-7-logo",
                Description =
